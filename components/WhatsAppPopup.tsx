...
export default function WhatsAppPopup() {
  ...
  }, [mounted, timeOnPage, scrollPercentage, exitIntentDetected, showPopup, userInteracted]);
  ...
  if (!mounted || !showPopup || (typeof window !== 'undefined' && localStorage.getItem('whatsapp_popup_closed') === 'true')) {
    return null;
  }
